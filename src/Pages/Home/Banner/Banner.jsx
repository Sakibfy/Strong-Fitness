      ...
      >
          <SwiperSlide className='relative'>
           ...
           <div className='absolute md:top-80 top-20 space-y-2 left-16 md:space-y-10 md:left-20  text-white'>
            ...
            <h2 className='uppercase md:text-7xl text-xl font-bold'>make you be the fighter</h2>
             <button className='absolute bg-lime-400 text-black md:font-bold  md:p-5 p-[5px] md:text-xl text-[14px] rounded-md hover:bg-lime-500 duration-300'>Know More</button>
           </div>
          </SwiperSlide>
          <SwiperSlide className='relative'>
          ...
          <SwiperSlide className='relative'>
           ...
           <div className='absolute md:top-80 top-20 space-y-2 left-16 md:space-y-10 md:left-20  text-white'>
               <button className='uppercase md:border-2 md:p-2 md:text-3xl text-[10px]'>strong fitness clus</button>
            <h2 className='uppercase md:text-7xl text-xl font-bold'>make you be the fighter</h2>
             <button className='absolute bg-lime-400 text-black md:font-bold  md:p-5 p-[5px] text-[14px] rounded-md hover:bg-lime-500 duration-300'>Know More</button>
           </div>
          </SwiperSlide>
